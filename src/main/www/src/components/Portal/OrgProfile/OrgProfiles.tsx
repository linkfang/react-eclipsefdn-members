import { Container, createStyles, makeStyles, Typography, TextField, Button } from '@material-ui/core';
    ...
    <>
      ...
      <Container className={classes.mainCtn}>
        ...
        <Typography variant="body1">
          Lorem ipsum dolor, sit amet consectetur adipisicing elit. Fuga, odio quisquam ad delectus unde repellendus
          alias culpa nulla magni facere repudiandae, temporibus autem eum aperiam tempore explicabo illum quaerat
          libero.
        </Typography>
        <div className="row">
